...
const AboutUs = () => {
  ...
  <div className="mx-auto max-w-xl flex flex-col items-center justify-center text-center rounded-3xl bg-white space-y-2 shadow-md rounded-3xl p-0 mb-8"><br/>
    ...
    <div className="py-16 bg-white/25 rounded-3xl p-4 mb-4 items-center justify-center "  >
          <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6 ">


            <section className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
              <div className="bg-white rounded-3xl p-4 mb-4 items-center justify-center">
                <h2 className="text-2xl text-[#23262B] font-bold md:text-4xl">
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Our Mission</h3>
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Our Vision</h3>
              <p className="mt-4 text-gray-600">
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Facilities</h3>
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Programs and Activities</h3>
              <ul className="mt-4 text-gray-600 list-disc pl-5">
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Our Team</h3>
              <p className="mt-4 text-gray-600">
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Get Involved</h3>
              <p className="mt-4 text-gray-600">
            ...
            <section className="mt-12 bg-white rounded-3xl p-4 mb-4 items-center justify-center">
              <h3 className="text-3xl text-[#23262B] font-bold">Contact Us</h3>
              <p className="mt-4 text-gray-600">
