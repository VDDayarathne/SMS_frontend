    ...
    <><><section className="m-4 md:m-8 dark:bg-gray-100 dark:text-gray-800">
          <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
              ...
              <div className="flex flex-col px-8 py-6">
                  ...
                  <button className="px-8 py-3 m-2 text-lg bg-gray-700 border rounded dark:text-white dark:border-gray-300">Add</button>
                      <button className="px-8 py-3 m-2 text-lg bg-gray-700 border rounded dark:text-white dark:border-gray-300">Update</button>
                      <button className="px-8 py-3 m-2 text-lg bg-gray-700 border rounded dark:text-white dark:border-gray-300">Delete</button>
                      <
