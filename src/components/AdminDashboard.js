                ...
                <ul class="my-1">
                    ...
                    <div class="flex-grow flex items-center border-b border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                      <div class="flex-grow flex justify-between items-center">
                        <div class="self-center">
                          <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Sahan Bandara</a> mentioned <a class="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Bimal Perera</a> in a new post
                        </div>
                  ...
                  <li class="flex px-4">
                    ...
                    <div class="flex-grow flex items-center border-gray-100 text-sm text-gray-600 dark:text-gray-50 py-2">
                      <div class="flex-grow flex justify-between items-center">
                        <div class="self-center">
                          The post <a class="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Post Name</a> was removed by <a class="font-medium text-gray-800 hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100" href="#0" style="outline: none;">Sahan Bandara</a>
                        </div>
                        <div class="flex-shrink-0 ml-2">
                          <a class="flex items-center font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500" href="#0" style="outline: none;">
                            View<span><svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" class="transform transition-transform duration-500 ease-in-out"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg></span>
                  ...
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Hansi Marawila</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">Computing</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">20/21</td>
                    <td class="px-4 py-3 text-xs">
                      <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> Approved </span>
                    </td>
                    <td class="px-4 py-3 text-sm">15-01-2024</td>
                  </tr>
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Kavinda Bandara</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">Applied</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">21/22</td>
                    <td class="px-4 py-3 text-xs">
                      <span class="px-2 py-1 font-semibold leading-tight text-yellow-700 bg-yellow-100 rounded-full"> Pending </span>
                    </td>
                    <td class="px-4 py-3 text-sm">23-03-2024</td>
                  </tr>
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Gayan </p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">Applied</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">17/18</td>
                    <td class="px-4 py-3 text-xs">
                    ...
                    <td class="px-4 py-3 text-sm">09-02-2024</td>
                  </tr>
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Ravindu</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">Geomatics</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">18/19</td>
                    <td class="px-4 py-3 text-xs">
                      <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> Approved </span>
                    </td>
                    <td class="px-4 py-3 text-sm">17-04-2024</td>
                  </tr>
                  <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Hiruni </p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">Computing</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">19/20</td>
                    <td class="px-4 py-3 text-xs">
                    ...
                    <td class="px-4 py-3 text-sm">11-01-2024</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
              ...
              <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                ...
                <div class="ml-4 text-md tracking-wide font-semibold w-40"> Faculty of Applied Sciences
              ...
              <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                ...
                <div class="ml-4 text-md tracking-wide font-semibold w-40">(+94) 45-2280291 / (+94) 45-2280015</div>
              </div>
              ...
              <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                ...
                <div class="ml-4 text-md tracking-wide font-semibold w-40">dean@appsc.sab.ac.lk</div>
              </div>
            </div>
