...
<section className="p-4 lg:p-8 dark:bg-[#787578] dark:text-[#23262B]">
	<div className="container mx-auto space-y-8 py-1 sm:px-6 lg:px-8">
		<div className="flex flex-col overflow-hidden rounded-3xl shadow-sm lg:flex-row">
		...
		<div className="flex flex-col overflow-hidden rounded-3xl shadow-sm lg:flex-row-reverse">
