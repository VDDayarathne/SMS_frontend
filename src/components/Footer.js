...
<footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<img
                  ...
                  />
					<svg xmlns="https://www.wemakescholars.com/admin/uploads/providers/3JVNxCbjtw-huBlkXje2sBwXRq-CjNGk.png" viewBox="0 0 32 32" fill="currentColor" className="flex-shrink-0 w-5 h-5 rounded-full dark:text-gray-50">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-900">Quick Access</h3>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-900">Terms and policies</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<a rel="noopener noreferrer" href="#">dean@appsc.sab.ac.lk</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© Sabaragamuwa University of Sri Lanka 2024. All rights reserved.</div>
</footer>
)
}